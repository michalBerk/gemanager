...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td>";
    echo "<button class='edit-button' style='border-radius:50px;' data-diamond-id='{$row['diamond_id']}'>Edit</button>";
    echo "<button class='delete-button' style='border-radius:50px; color:white; background-color: #FF6565;' data-diamond-id='{$row['diamond_id']}'>Delete</button>";
    echo "</td>";
    echo "</tr>";
}
